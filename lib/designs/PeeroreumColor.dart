...
final class PeeroreumColor extends Color {
  ...
  static const Map<String, List<Color>> subjectColor = <String, List<Color>>{
    "국어": [
      Color.fromARGB(255, 255, 242, 233),
      Color.fromARGB(255, 248, 123, 96)
    ],
    "수학": [
      Color.fromARGB(255, 233, 246, 255),
      Color.fromARGB(255, 96, 148, 248)
    ],
    "영어": [
      Color.fromARGB(255, 240, 255, 233),
      Color.fromARGB(255, 129, 219, 87)
    ],
    "사회": [
      Color.fromARGB(255, 255, 250, 233),
      Color.fromARGB(255, 248, 205, 96)
    ],
    "과학": [
      Color.fromARGB(255, 255, 233, 249),
      Color.fromARGB(255, 248, 96, 169)
    ],
    "전체": [
    ...
    "대학": [
      Color.fromARGB(255, 236, 233, 255),
      Color.fromARGB(255, 114, 96, 248)
    ]
  };
